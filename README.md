...
Instala tudo com npm install.

Cria um arquivo .env seguindo o exemplo do .env.example com suas chaves do Supabase.

Roda o script que está em supabase/schema.sql lá no editor do seu projeto Supabase.

Dá um npm run dev e pronto.
